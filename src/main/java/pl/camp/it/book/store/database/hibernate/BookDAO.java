...
public class BookDAO implements IBookDAO {
    ...
    final String GET_ALL_BOOK_QUERY = "FROM pl.camp.it.book.store.model.Book";
    final String GET_BOOKS_BY_PATTERN_QUERY = "FROM pl.camp.it.book.store.model.Book WHERE title LIKE :pattern OR author LIKE :pattern";
    final String GET_BOOK_BY_ID_QUERY = "FROM pl.camp.it.book.store.model.Book WHERE id = :id";
    ...
    public List<Book> getAllBooks() {
        ...
        Query<Book> query = session.createQuery(GET_ALL_BOOK_QUERY, Book.class);
    ...
    public Optional<Book> getBookByIdCriteriaQuery(int id) {
        ...
        criteriaQuery
                ...
                .where(criteriaBuilder.or(
                        ...
                        criteriaBuilder.equal(bookRoot.get("title"), "cos")
                )
                .groupBy()
                .orderBy();
